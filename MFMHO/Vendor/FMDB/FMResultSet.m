    ...
    if (num_cols > 0) {
        ...
        for (columnIdx = 0; columnIdx < columnCount; columnIdx++) {
            ...
            if ([objectValue isKindOfClass:[NSNull class]]) {
                ...
                objectValue =[[NSString alloc] initWithCString:c encoding:CFStringConvertEncodingToNSStringEncoding(kCFStringEncodingGB_18030_2000)];
                    }
                }
            }
...
- (NSArray*)resultArrayWithCount:(NSInteger)count{
    NSUInteger num_cols = (NSUInteger)sqlite3_data_count([_statement statement]);
    ...
    if (num_cols > 0) {
        ...
        int columnIdx = columnCount/count*i;
        NSMutableDictionary *dict = [NSMutableDictionary dictionaryWithCapacity:columnCount/count];

        for (columnIdx = columnCount/count*i; columnIdx < columnCount/count*(i+1); columnIdx++) {
...
- (NSArray*)resultArrayIsFastWithCount:(NSInteger)count{
    NSUInteger num_cols = (NSUInteger)sqlite3_data_count([_statement statement]);
    ...
    if (num_cols > 0) {
        ...
        for (int i =0; i<count; i++) {
            ...
            int columnIdx = columnCount/count*i;
            NSMutableArray *array = [NSMutableArray arrayWithCapacity:columnCount/count];
